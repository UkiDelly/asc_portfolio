class AdminCheckUserProduct {
  ...
  AdminCheckUserProduct({
    required this.productState, required this.productNameType, required this.productNameTypeString,
    required this.description, required this.productPrice,
    required this.productLabel, required this.createDate});
