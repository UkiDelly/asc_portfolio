...
class HomeStateNotifier extends _$HomeStateNotifier {
  ...
  HomeController build() {
    ...
    ticketRepository = ref.watch(ticketRepoProvider);
...
// final homeStateProvider = StateNotifierProvider<HomeStateNotifie, HomeController>((ref) {
...
// class HomeStateNotifie extends StateNotifier<HomeController> {
